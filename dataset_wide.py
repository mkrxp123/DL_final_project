...
from HC_Net.models.utils.utils import get_BEV_tensor, get_BEV_projection
from HC_Net.models.utils.augment import train_transform
...
class VIGOR(Dataset):
    def __init__(self, args, split='train', root='Data/VIGOR/', same_area=True):
        ...
        if same_area:
            self.train_city_list =['Chicago'] # ['NewYork', 'Seattle', 'SanFrancisco', 'Chicago'] ['Seattle'] 
