...
class APP:
    ...
    def localize(self, grd_img, sat_img, sat_gps):
        ...
        topn_value, topn_index = torch.topk(matrix, self.topn, dim=-1, largest=False)
        # print(f'topn_index: {topn_index}')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight',     type=str, default=root.joinpath("log/test/weight/best.pt"), help="transformer weight")
